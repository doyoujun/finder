...
<%@ include file="include/sidebar.jsp"%>
  ...
  <h3 style="text-align: center; font-weight: bold; color: #231815;">장비 / 차량등록</h3>
<div class="" style="margin-top:40px;">
				<div class="" style="display:flex; justify-content: center;">
					...
					<div direction="column" class="" style="background: #fff; width:800px;justify-content: center;" >
						<form method="POST" id="vehicleRegiform" name="vehicleRegiform" enctype="multipart/form-data">
							<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
							<div class="sc-lcujXC bnKPcn" style="width: 724px; margin: 0 auto;">
								<img alt="" src="${pageContext.request.contextPath}/resources/assets/img/icon_img_02.png" style="width: 617px; height: 389px;display: flex;margin: auto;" id="image">
							
								<div class=" ">
									<div class=" " style="margin-top: 50px;">
										<div class="" style="color: #555555;">차량/장비명 <span style="color:red;">*</span> </div> 
										<div class="" style="margin-top: 5px; ">
											<input type="text" class="" id="vequipname" style="padding: 0 20px; height: 46px; border-radius: 5px; width: 724px; border: 1px solid #DDDDDD;" placeholder="ex)이동차량/덤프트럭" name="vequipname">
										</div>
									</div>
								</div>
								...
								<div class=" " style="margin-top: 25px;">
									<div class=" ">
										...
										<div class="" style="margin-top: 5px;">
											<input type="text" class="" id="venumber" style="padding: 0 20px; height: 46px; border-radius: 5px; width: 100%;border: 1px solid #DDDDDD;" placeholder="차량번호를 입력해주세요." name="venumber">
										</div>
									</div>
								</div>
								<div class=" " style="margin-top: 25px;">
									<div class=" ">
										...
										<div class="" style="margin-top: 5px;">
											<input type="text" class="" id="vedate" style="padding: 0 20px; height: 46px; border-radius: 5px; width: 100%;border: 1px solid #DDDDDD;" placeholder="등록날짜를 입력해주세요." name="vedate">
										</div>
									</div>
								</div>
								<div class=" " style="margin-top: 25px;">
									<div class=" ">
										...
										<div class="" style="margin-top: 5px;">
											<input type="text" class="" id="vemanager" style="padding: 0 20px; height: 46px; border-radius: 5px; width: 100%;border: 1px solid #DDDDDD;" placeholder="담당자를 입력해주세요." name="vemanager">
										</div>
										<div style = display:none; id="enterpriseidx">${enterprise}</div>
										<div style = display:none; id="enterpriseidx">${enterpriseinfo}</div>
									</div>
								</div>
							...
							<div class="" style="display: flex; margin-top: 55px; justify-content: center;">
								<button type="button" style=" cursor:pointer; margin: 0; font-size: 16px; border: none; color: #fff; width: 122px; height: 50px; background: #003388; border-radius: 12px;" color="#fff" id="join" type="button" onclick="vehicleRegist_btn(${enterprise}, ${enterpriseinfo})">등록하기</button>
							</div>
						</form>
					</div>
				</div>
...
<script src="${pageContext.request.contextPath}/resources/assets/js/enterprise/createvehicle.js"></script>