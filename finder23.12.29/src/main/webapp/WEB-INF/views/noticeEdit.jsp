...
<script src="<%=request.getContextPath()%>/resources/assets/js/ckeditor/ckeditor.js"></script>
  ...
  <h3 style="text-align: center; font-weight: bold;">공지사항 수정</h3>
       ...
       <div style="display:none;" id="context">${pageContext.request.contextPath}</div>
      	<div style="display: flex;justify-content: center;margin:70px auto 25px auto; ">
      		...
      		<input type="text" class="" id="noticetitle" style="padding: 0 20px; height: 52px; border-radius: 5px; width: 582px;border: 0.67px solid #DDDDDD;" value="${data[0].notice_title}" name="noticetitle">   		
       	</div>
		<div style="width: 1247px;margin: 0px auto; ">
      	...
      	<div class="" style="display: flex; margin-top: 55px; justify-content: center;">
			<button type="button" style=" cursor:pointer; margin: 0; font-size: 16px; border: none; color: #fff; width: 122px; height: 50px; background: #003388; border-radius: 12px;" color="#fff" id="noticeRegist" type="button" onclick="noticeRegist_btn(${data[0].notice_index})">등록</button>
		</div>
  <!--end wrapper-->
  </div>
...
<script src="${pageContext.request.contextPath}/resources/assets/js/enterprise/noticeedit.js"></script>
